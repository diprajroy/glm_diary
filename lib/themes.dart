...
class CustomTheme {
  var baseTheme = ThemeData.light().copyWith(
    scaffoldBackgroundColor: KdipPrimarycolor,
    primaryColor: KdipPrimarycolor,
    appBarTheme: AppBarTheme(
      //height for both phone and tablet
      toolbarHeight: SizerUtil.deviceType == DeviceType.tablet ? 9.h : 7.h,
      backgroundColor: KdipPrimarycolor,
    ...
    textTheme: GoogleFonts.poppinsTextTheme().copyWith(
      ...
      titleSmall: GoogleFonts.poppins(
          color: kTextWhiteColor,
          fontSize: SizerUtil.deviceType == DeviceType.tablet ? 12.sp : 12.sp,
